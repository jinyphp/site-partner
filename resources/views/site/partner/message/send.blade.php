<div wire:poll.5s>
    ...
    <div class="flex flex-col space-y-4 p-4 mb-4 bg-gray-50">
        @foreach ($rows as $msg)
            <div class="flex {{ $msg->direction == 'send' ? 'justify-end' : 'justify-start' }}">
                ...
                @if($msg->image)
                    <div class="rounded-lg p-3 {{ $msg->direction == 'send' ? 'bg-blue-100' : 'bg-blue-200' }} max-w-[70%] relative">
                        @if($msg->direction == 'send')
                ...
                @else
                    <div class="rounded-lg p-3 {{ $msg->direction == 'send' ? 'bg-yellow-100' : 'bg-blue-200' }} max-w-[70%] relative">
                        @if($msg->direction == 'send')
                            <span style="position:absolute; right:5px; top:3px"
                                wire:click="deleteMessage({{ $msg->id }})"
                                class="text-red-500 hover:text-red-700">
